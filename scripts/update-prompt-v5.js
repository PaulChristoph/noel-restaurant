/**
 * Retell LLM v5: cancel_appointment Tool + Umbuchungs-Flow
 */
...
3. Bei Bestaetigung: cancel_appointment aufrufen.
4. Ergebnis vorlesen. Bedanken.
...
5. Bei Verfuegbarkeit: cancel_appointment fuer alten Termin aufrufen (WICHTIG: erst stornieren!).
...
async function main() {
  ...
  console.log('✓ LLM v5 aktualisiert — Tools:', toolNames.join(', '));
}
